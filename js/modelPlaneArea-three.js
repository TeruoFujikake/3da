...
// カメラ設定
const camera = new THREE.PerspectiveCamera(75, modelPlaneAreaWidth / modelPlaneAreaHeight, 0.1, 1000);
...
// セクション切り替えを監視
const planeSection = document.querySelector('#modelPlaneArea').closest('.js-section');
